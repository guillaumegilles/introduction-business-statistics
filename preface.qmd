...
that provides a "simplified" version of reality" [@mathematics:-a-very-short-introduction].

While this list is not exhaustive, most statistical models falls into at
least one of these 3 categories [@978-1492096481 - Tidy Modeling with R: A Framework for Modeling in the Tidyverse]:
...
than to visually emphasize some trend or artifact in the data [@978-1492096481kuhnTidyModeling2022].
